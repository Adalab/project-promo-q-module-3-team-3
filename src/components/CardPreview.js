    ...
    return (
        <section
            ...
            <div className="wrapper">
                ...
                <article className={`card js_cardPreview palette${props.dataCard.palette}`}>
                    <div className="card__rectangle"></div>
                    <div className="card__info">
                        <h3 className="card__name js_cardname">{props.dataCard.name || `Nombre y Apellidos`}</h3>
                        <p className="card__job js_cardjob">{props.dataCard.job || `Front-end developer`}</p>
                    </div>
